...
def extract_features(imgs, feature_fns, verbose=False):
    ...
    on single images, apply all feature functions to all images, concatenating
    the feature vectors for each image and storing the features for all images
    in a single matrix.
...
def color_histogram_hsv(im, nbin=10, xmin=0, xmax=255, normalized=True):
    ...
    Returns:
        1D vector of length nbin giving the color histogram over
